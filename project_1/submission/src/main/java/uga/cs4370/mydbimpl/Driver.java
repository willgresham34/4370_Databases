...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        Relation course = new RelationBuilder()
                ...
                .build();
        course.loadData("C:/Users/adamb/Documents/DATABASE/Projects/p1/4370_Databases/project_1/submission/src/main/java/uga/cs4370/mydbimpl/tables/course_export.csv");
         ...
         * Adam's Query
         */
        //Find advisors of students who major in Math. Return the advisors that are
