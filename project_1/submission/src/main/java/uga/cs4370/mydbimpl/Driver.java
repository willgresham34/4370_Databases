...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        //Relation math_students = ra.select(students,
        //        row -> row.get(students.getAttrIndex("dept_name")).getAsString().equals("Math"));
        ...
        //Relation adv_of_math = ra.join(math_ids, advisors,
        ...
        //Relation inst_math = ra.join(adv_id, instructors,
        ...
        public static void main(String[] args) {
                ...
                Relation department = new RelationBuilder()
                                ...
                                .build();
                department.loadData(
                                "./project_1/submission/src/main/java/uga/cs4370/mydbimpl/tables/department_export.csv");
                ...
                Relation classroom = new RelationBuilder()
                                ...
                                .build();
                classroom.loadData(
                                "./project_1/submission/src/main/java/uga/cs4370/mydbimpl/tables/classroom_export.csv");
                ...
                instructors.loadData(
                                "./project_1/submission/src/main/java/uga/cs4370/mydbimpl/tables/instructor_export.csv");
                ...
                // Get all Civil Eng. Courses with course id and type
                // Relation civilEngCourses = ra.select(course,
                // row -> row.get(course.getAttrIndex("dept_name")).getAsString().equals("Civil
                // Eng."));
                // // Project only course_id
                // Relation civilEngCid = ra.project(civilEngCourses, List.of("course_id"));
                // // Join Civil Eng. classes on takes to get all civil eng course taken
                ...
                // row -> row.get(takesCivilEngCourse.getAttrIndex("year")).getAsInt() == 2009);
                // // Project only id
                // Relation idTakesCivilEngCourse2009 = ra.project(takesCivilEngCourse2009,
                // List.of("ID"));
                // // Join on student
                // Relation studentTakesCivilEngCourse2009 = ra.join(idTakesCivilEngCourse2009,
                // students);
                // // Project name, major
                // Relation stu_nameMajorCivilEngCourse2009 =
                // ra.project(studentTakesCivilEngCourse2009, List.of("name", "dept_name"));

                // System.out.println("Name/Dept of students who took any class in Civil Eng. in
                // 2009:");
                // stu_nameMajorCivilEngCourse2009.print();
        }
