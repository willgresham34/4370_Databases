...
public class SetService {
    ...
    public FullSet constructFullSet(String setId) throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            rs1.next();
            String[] setInfo = { rs1.getString("setName"), rs1.getString("setDescription"),
                    rs1.getString("setCategory") };
    ...
    public List<Set> currentUserSets() throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            while (rs.next()) {
                Set tempSet = new Set(rs.getString("setId"), rs.getString("setName"), rs.getString("setDescription"),
                        rs.getString("setCategory"));
